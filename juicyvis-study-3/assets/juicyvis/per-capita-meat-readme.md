# Per capita meat and fish consumption - Data package

This data package contains the data that powers the chart ["Per capita meat and fish consumption"](https://ourworldindata.org/grapher/per-capita-meat-type?v=1&csvType=full&useColumnShortNames=false) on the Our World in Data website.
